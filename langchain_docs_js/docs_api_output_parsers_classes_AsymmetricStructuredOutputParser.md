AsymmetricStructuredOutputParser<T, Y\>
=======================================
...
*   [`BaseOutputParser`](/docs/api/schema_output_parser/classes/BaseOutputParser)<`Y`\>.**AsymmetricStructuredOutputParser**
...
> **new AsymmetricStructuredOutputParser**<T, Y\>(«destructured»: `AsymmetricStructuredOutputParserFields`<`T`\>): [`AsymmetricStructuredOutputParser`](/docs/api/output_parsers/classes/AsymmetricStructuredOutputParser)<`T`, `Y`\>
...
[`AsymmetricStructuredOutputParser`](/docs/api/output_parsers/classes/AsymmetricStructuredOutputParser)<`T`, `Y`\>
...
[langchain/src/output\_parsers/structured.ts:206](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/output_parsers/structured.ts#L206)
...
> **\_streamIterator**(`input`: `string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage), `options`?: `Partial`<`BaseCallbackConfig`\>): `AsyncGenerator`<`Y`, `any`, `unknown`\>
...
> **batch**(`inputs`: (`string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage))\[\], `options`?: `Partial`<`BaseCallbackConfig`\> | `Partial`<`BaseCallbackConfig`\>\[\], `batchOptions`?: `object`): `Promise`<`Y`\[\]\>
...
> **bind**(`kwargs`: `Partial`<`BaseCallbackConfig`\>): [`RunnableBinding`](/docs/api/schema_runnable/classes/RunnableBinding)<`string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage), `Y`, `BaseCallbackConfig`\>
...
[`RunnableBinding`](/docs/api/schema_runnable/classes/RunnableBinding)<`string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage), `Y`, `BaseCallbackConfig`\>
...
> **invoke**(`input`: `string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage), `options`?: `BaseCallbackConfig`): `Promise`<`Y`\>
...
> `Abstract` **outputProcessor**(`input`: `TypeOf`<`T`\>): `Promise`<`Y`\>
...
[langchain/src/output\_parsers/structured.ts:213](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/output_parsers/structured.ts#L213)
...
> **parseResult**(`generations`: [`Generation`](/docs/api/schema/interfaces/Generation)\[\] | [`ChatGeneration`](/docs/api/schema/interfaces/ChatGeneration)\[\], `callbacks`?: [`Callbacks`](/docs/api/callbacks/types/Callbacks)): `Promise`<`Y`\>
...
> **parseResultWithPrompt**(`generations`: [`Generation`](/docs/api/schema/interfaces/Generation)\[\] | [`ChatGeneration`](/docs/api/schema/interfaces/ChatGeneration)\[\], `_prompt`: [`BasePromptValue`](/docs/api/schema/classes/BasePromptValue), `callbacks`?: [`Callbacks`](/docs/api/callbacks/types/Callbacks)): `Promise`<`Y`\>
...
> **parseWithPrompt**(`text`: `string`, `_prompt`: [`BasePromptValue`](/docs/api/schema/classes/BasePromptValue), `callbacks`?: [`Callbacks`](/docs/api/callbacks/types/Callbacks)): `Promise`<`Y`\>
...
> **pipe**<NewRunOutput\>(`coerceable`: [`RunnableLike`](/docs/api/schema_runnable/types/RunnableLike)<`Y`, `NewRunOutput`\>): [`RunnableSequence`](/docs/api/schema_runnable/classes/RunnableSequence)<`string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage), `NewRunOutput`\>
...
[`RunnableLike`](/docs/api/schema_runnable/types/RunnableLike)<`Y`, `NewRunOutput`\>
...
> **stream**(`input`: `string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage), `options`?: `Partial`<`BaseCallbackConfig`\>): `Promise`<`IterableReadableStream`<`Y`\>\>
...
`Promise`<`IterableReadableStream`<`Y`\>\>
...
> `Protected` **\_callWithConfig**<T\>(`func`: `Function`, `input`: `T`, `options`?: `BaseCallbackConfig` & {`runType`?: `string`;}): `Promise`<`Y`\>
