...
*   [`BaseMessageChunk`](/docs/api/schema/classes/BaseMessageChunk).**AIMessageChunk**
...
> **new AIMessageChunk**(`fields`: `string` | [`BaseMessageFields`](/docs/api/schema/interfaces/BaseMessageFields), `kwargs`?: `Record`<`string`, `unknown`\>): [`AIMessageChunk`](/docs/api/schema/classes/AIMessageChunk)
...
[`AIMessageChunk`](/docs/api/schema/classes/AIMessageChunk)
...
[langchain/src/schema/index.ts:233](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/schema/index.ts#L233)

### concat()[](#concat "Direct link to concat()")

> **concat**(`chunk`: [`AIMessageChunk`](/docs/api/schema/classes/AIMessageChunk)): [`AIMessageChunk`](/docs/api/schema/classes/AIMessageChunk)
...
[langchain/src/schema/index.ts:237](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/schema/index.ts#L237)
