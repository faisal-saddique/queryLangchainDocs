...
*   [`VectorStore`](/docs/api/vectorstores_base/classes/VectorStore).**MyScaleStore**
...
> **new MyScaleStore**(`embeddings`: [`Embeddings`](/docs/api/embeddings_base/classes/Embeddings), `args`: [`MyScaleLibArgs`](/docs/api/vectorstores_myscale/interfaces/MyScaleLibArgs)): [`MyScaleStore`](/docs/api/vectorstores_myscale/classes/MyScaleStore)
...
[langchain/src/vectorstores/myscale.ts:58](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/myscale.ts#L58)
...
> **FilterType**: [`MyScaleFilter`](/docs/api/vectorstores_myscale/interfaces/MyScaleFilter)
...
[langchain/src/vectorstores/myscale.ts:36](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/myscale.ts#L36)
...
[langchain/src/vectorstores/myscale.ts:54](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/myscale.ts#L54)
...
[langchain/src/vectorstores/myscale.ts:94](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/myscale.ts#L94)
...
[langchain/src/vectorstores/myscale.ts:81](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/myscale.ts#L81)

### asRetriever()[](#asretriever "Direct link to asRetriever()")

> **asRetriever**(`kOrFields`?: `number` | `Partial`<[`VectorStoreRetrieverInput`](/docs/api/vectorstores_base/interfaces/VectorStoreRetrieverInput)<[`MyScaleStore`](/docs/api/vectorstores_myscale/classes/MyScaleStore)\>\>, `filter`?: [`MyScaleFilter`](/docs/api/vectorstores_myscale/interfaces/MyScaleFilter), `callbacks`?: [`Callbacks`](/docs/api/callbacks/types/Callbacks), `tags`?: `string`\[\], `metadata`?: `Record`<`string`, `unknown`\>, `verbose`?: `boolean`): [`VectorStoreRetriever`](/docs/api/vectorstores_base/classes/VectorStoreRetriever)<[`MyScaleStore`](/docs/api/vectorstores_myscale/classes/MyScaleStore)\>
...
`number` | `Partial`<[`VectorStoreRetrieverInput`](/docs/api/vectorstores_base/interfaces/VectorStoreRetrieverInput)<[`MyScaleStore`](/docs/api/vectorstores_myscale/classes/MyScaleStore)\>\>
...
[`VectorStoreRetriever`](/docs/api/vectorstores_base/classes/VectorStoreRetriever)<[`MyScaleStore`](/docs/api/vectorstores_myscale/classes/MyScaleStore)\>
...
> **similaritySearch**(`query`: `string`, `k`: `number` = `4`, `filter`: `undefined` | [`MyScaleFilter`](/docs/api/vectorstores_myscale/interfaces/MyScaleFilter) = `undefined`, `_callbacks`: `undefined` | [`Callbacks`](/docs/api/callbacks/types/Callbacks) = `undefined`): `Promise`<[`Document`](/docs/api/document/classes/Document)<`Record`<`string`, `any`\>\>\[\]\>
...
`undefined` | [`MyScaleFilter`](/docs/api/vectorstores_myscale/interfaces/MyScaleFilter)
...
> **similaritySearchVectorWithScore**(`query`: `number`\[\], `k`: `number`, `filter`?: [`MyScaleFilter`](/docs/api/vectorstores_myscale/interfaces/MyScaleFilter)): `Promise`<\[[`Document`](/docs/api/document/classes/Document)<`Record`<`string`, `any`\>\>, `number`\]\[\]\>
...
[langchain/src/vectorstores/myscale.ts:101](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/myscale.ts#L101)

### similaritySearchWithScore()[](#similaritysearchwithscore "Direct link to similaritySearchWithScore()")

> **similaritySearchWithScore**(`query`: `string`, `k`: `number` = `4`, `filter`: `undefined` | [`MyScaleFilter`](/docs/api/vectorstores_myscale/interfaces/MyScaleFilter) = `undefined`, `_callbacks`: `undefined` | [`Callbacks`](/docs/api/callbacks/types/Callbacks) = `undefined`): `Promise`<\[[`Document`](/docs/api/document/classes/Document)<`Record`<`string`, `any`\>\>, `number`\]\[\]\>
...
> `Static` **fromDocuments**(`docs`: [`Document`](/docs/api/document/classes/Document)<`Record`<`string`, `any`\>\>\[\], `embeddings`: [`Embeddings`](/docs/api/embeddings_base/classes/Embeddings), `args`: [`MyScaleLibArgs`](/docs/api/vectorstores_myscale/interfaces/MyScaleLibArgs)): `Promise`<[`MyScaleStore`](/docs/api/vectorstores_myscale/classes/MyScaleStore)\>
...
`Promise`<[`MyScaleStore`](/docs/api/vectorstores_myscale/classes/MyScaleStore)\>
...
[langchain/src/vectorstores/myscale.ts:142](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/myscale.ts#L142)

### fromExistingIndex()[](#fromexistingindex "Direct link to fromExistingIndex()")

> `Static` **fromExistingIndex**(`embeddings`: [`Embeddings`](/docs/api/embeddings_base/classes/Embeddings), `args`: [`MyScaleLibArgs`](/docs/api/vectorstores_myscale/interfaces/MyScaleLibArgs)): `Promise`<[`MyScaleStore`](/docs/api/vectorstores_myscale/classes/MyScaleStore)\>
...
[langchain/src/vectorstores/myscale.ts:152](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/myscale.ts#L152)

### fromTexts()[](#fromtexts "Direct link to fromTexts()")

> `Static` **fromTexts**(`texts`: `string`\[\], `metadatas`: `object` | `object`\[\], `embeddings`: [`Embeddings`](/docs/api/embeddings_base/classes/Embeddings), `args`: [`MyScaleLibArgs`](/docs/api/vectorstores_myscale/interfaces/MyScaleLibArgs)): `Promise`<[`MyScaleStore`](/docs/api/vectorstores_myscale/classes/MyScaleStore)\>
...
[langchain/src/vectorstores/myscale.ts:124](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/myscale.ts#L124)