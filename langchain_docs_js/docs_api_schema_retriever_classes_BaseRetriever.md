...
*   [`Runnable`](/docs/api/schema_runnable/classes/Runnable)<`string`, [`Document`](/docs/api/document/classes/Document)\[\]\>.**BaseRetriever**
...
[langchain/src/schema/retriever.ts:31](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/schema/retriever.ts#L31)
...
[langchain/src/schema/retriever.ts:44](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/schema/retriever.ts#L44)
