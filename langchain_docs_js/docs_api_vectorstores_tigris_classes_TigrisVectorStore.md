...
*   [`VectorStore`](/docs/api/vectorstores_base/classes/VectorStore).**TigrisVectorStore**
...
> **new TigrisVectorStore**(`embeddings`: [`Embeddings`](/docs/api/embeddings_base/classes/Embeddings), `args`: [`TigrisLibArgs`](/docs/api/vectorstores_tigris/types/TigrisLibArgs)): [`TigrisVectorStore`](/docs/api/vectorstores_tigris/classes/TigrisVectorStore)
...
[langchain/src/vectorstores/tigris.ts:19](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/tigris.ts#L19)
...
> **index**: `VectorDocumentStore`

#### Defined in[](#defined-in-6 "Direct link to Defined in")

[langchain/src/vectorstores/tigris.ts:13](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/tigris.ts#L13)
...
[langchain/src/vectorstores/tigris.ts:15](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/tigris.ts#L15)

### addDocuments()[](#adddocuments "Direct link to addDocuments()")

> **addDocuments**(`documents`: [`Document`](/docs/api/document/classes/Document)<`Record`<`string`, `any`\>\>\[\], `options`?: `string`\[\] | {`ids`?: `string`\[\];}): `Promise`<`void`\>
...
[langchain/src/vectorstores/tigris.ts:26](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/tigris.ts#L26)

### addVectors()[](#addvectors "Direct link to addVectors()")

> **addVectors**(`vectors`: `number`\[\]\[\], `documents`: [`Document`](/docs/api/document/classes/Document)<`Record`<`string`, `any`\>\>\[\], `options`?: `string`\[\] | {`ids`?: `string`\[\];}): `Promise`<`void`\>
...
[langchain/src/vectorstores/tigris.ts:38](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/tigris.ts#L38)

### asRetriever()[](#asretriever "Direct link to asRetriever()")

> **asRetriever**(`kOrFields`?: `number` | `Partial`<[`VectorStoreRetrieverInput`](/docs/api/vectorstores_base/interfaces/VectorStoreRetrieverInput)<[`TigrisVectorStore`](/docs/api/vectorstores_tigris/classes/TigrisVectorStore)\>\>, `filter`?: `string` | `object`, `callbacks`?: [`Callbacks`](/docs/api/callbacks/types/Callbacks), `tags`?: `string`\[\], `metadata`?: `Record`<`string`, `unknown`\>, `verbose`?: `boolean`): [`VectorStoreRetriever`](/docs/api/vectorstores_base/classes/VectorStoreRetriever)<[`TigrisVectorStore`](/docs/api/vectorstores_tigris/classes/TigrisVectorStore)\>
...
`number` | `Partial`<[`VectorStoreRetrieverInput`](/docs/api/vectorstores_base/interfaces/VectorStoreRetrieverInput)<[`TigrisVectorStore`](/docs/api/vectorstores_tigris/classes/TigrisVectorStore)\>\>
...
[`VectorStoreRetriever`](/docs/api/vectorstores_base/classes/VectorStoreRetriever)<[`TigrisVectorStore`](/docs/api/vectorstores_tigris/classes/TigrisVectorStore)\>
...
[langchain/src/vectorstores/tigris.ts:63](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/tigris.ts#L63)
...
> `Static` **fromDocuments**(`docs`: [`Document`](/docs/api/document/classes/Document)<`Record`<`string`, `any`\>\>\[\], `embeddings`: [`Embeddings`](/docs/api/embeddings_base/classes/Embeddings), `dbConfig`: [`TigrisLibArgs`](/docs/api/vectorstores_tigris/types/TigrisLibArgs)): `Promise`<[`TigrisVectorStore`](/docs/api/vectorstores_tigris/classes/TigrisVectorStore)\>
...
`Promise`<[`TigrisVectorStore`](/docs/api/vectorstores_tigris/classes/TigrisVectorStore)\>
...
[langchain/src/vectorstores/tigris.ts:105](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/tigris.ts#L105)

### fromExistingIndex()[](#fromexistingindex "Direct link to fromExistingIndex()")

> `Static` **fromExistingIndex**(`embeddings`: [`Embeddings`](/docs/api/embeddings_base/classes/Embeddings), `dbConfig`: [`TigrisLibArgs`](/docs/api/vectorstores_tigris/types/TigrisLibArgs)): `Promise`<[`TigrisVectorStore`](/docs/api/vectorstores_tigris/classes/TigrisVectorStore)\>
...
[langchain/src/vectorstores/tigris.ts:115](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/tigris.ts#L115)

### fromTexts()[](#fromtexts "Direct link to fromTexts()")

> `Static` **fromTexts**(`texts`: `string`\[\], `metadatas`: `object` | `object`\[\], `embeddings`: [`Embeddings`](/docs/api/embeddings_base/classes/Embeddings), `dbConfig`: [`TigrisLibArgs`](/docs/api/vectorstores_tigris/types/TigrisLibArgs)): `Promise`<[`TigrisVectorStore`](/docs/api/vectorstores_tigris/classes/TigrisVectorStore)\>
...
[langchain/src/vectorstores/tigris.ts:87](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/vectorstores/tigris.ts#L87)