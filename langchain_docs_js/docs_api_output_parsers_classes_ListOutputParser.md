...
*   [`BaseOutputParser`](/docs/api/schema_output_parser/classes/BaseOutputParser)<`string`\[\]\>.**ListOutputParser**
...
> **new ListOutputParser**(`kwargs`?: `SerializedFields`, ...`_args`?: `never`\[\]): [`ListOutputParser`](/docs/api/output_parsers/classes/ListOutputParser)
...
> `Abstract` **parse**(`text`: `string`, `callbacks`?: [`Callbacks`](/docs/api/callbacks/types/Callbacks)): `Promise`<`string`\[\]\>
