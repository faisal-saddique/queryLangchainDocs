...
*   [`BaseMessage`](/docs/api/schema/classes/BaseMessage).**HumanMessage**
...
> **new HumanMessage**(`fields`: `string` | [`BaseMessageFields`](/docs/api/schema/interfaces/BaseMessageFields), `kwargs`?: `Record`<`string`, `unknown`\>): [`HumanMessage`](/docs/api/schema/classes/HumanMessage)
...
[langchain/src/schema/index.ts:205](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/schema/index.ts#L205)
