...
*   [`AgentActionOutputParser`](/docs/api/agents/classes/AgentActionOutputParser).**StructuredChatOutputParserWithRetries**
...
> **new StructuredChatOutputParserWithRetries**(`fields`: [`StructuredChatOutputParserArgs`](/docs/api/agents/interfaces/StructuredChatOutputParserArgs)): [`StructuredChatOutputParserWithRetries`](/docs/api/agents/classes/StructuredChatOutputParserWithRetries)
...
[langchain/src/agents/structured\_chat/outputParser.ts:68](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/agents/structured_chat/outputParser.ts#L68)
...
[langchain/src/agents/structured\_chat/outputParser.ts:60](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/agents/structured_chat/outputParser.ts#L60)
...
[langchain/src/agents/structured\_chat/outputParser.ts:87](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/agents/structured_chat/outputParser.ts#L87)
...
> **parse**(`text`: `string`, `callbacks`?: [`Callbacks`](/docs/api/callbacks/types/Callbacks)): `Promise`<[`AgentAction`](/docs/api/schema/types/AgentAction) | [`AgentFinish`](/docs/api/schema/types/AgentFinish)\>
...
[langchain/src/agents/structured\_chat/outputParser.ts:77](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/agents/structured_chat/outputParser.ts#L77)
...
> `Static` **fromLLM**(`llm`: [`BaseLanguageModel`](/docs/api/base_language/classes/BaseLanguageModel)<`any`, [`BaseLanguageModelCallOptions`](/docs/api/base_language/interfaces/BaseLanguageModelCallOptions)\>, `options`: `Omit`<[`StructuredChatOutputParserArgs`](/docs/api/agents/interfaces/StructuredChatOutputParserArgs), "outputFixingParser"\>): [`StructuredChatOutputParserWithRetries`](/docs/api/agents/classes/StructuredChatOutputParserWithRetries)
...
`Omit`<[`StructuredChatOutputParserArgs`](/docs/api/agents/interfaces/StructuredChatOutputParserArgs), "outputFixingParser"\>
...
[langchain/src/agents/structured\_chat/outputParser.ts:93](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/agents/structured_chat/outputParser.ts#L93)
