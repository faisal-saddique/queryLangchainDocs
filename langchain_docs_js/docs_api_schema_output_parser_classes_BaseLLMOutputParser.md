...
*   [`Runnable`](/docs/api/schema_runnable/classes/Runnable)<`string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage), `T`\>.**BaseLLMOutputParser**
...
[langchain/src/schema/output\_parser.ts:19](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/schema/output_parser.ts#L19)
