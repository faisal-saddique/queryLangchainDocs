...
[langchain/src/experimental/plan\_and\_execute/outputParser.ts:7](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/experimental/plan_and_execute/outputParser.ts#L7)
...
> **\_streamIterator**(`input`: `string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage), `options`?: `Partial`<`BaseCallbackConfig`\>): `AsyncGenerator`<[`Plan`](/docs/api/experimental_plan_and_execute/types/Plan), `any`, `unknown`\>
...
`AsyncGenerator`<[`Plan`](/docs/api/experimental_plan_and_execute/types/Plan), `any`, `unknown`\>
...
> **batch**(`inputs`: (`string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage))\[\], `options`?: `Partial`<`BaseCallbackConfig`\> | `Partial`<`BaseCallbackConfig`\>\[\], `batchOptions`?: `object`): `Promise`<[`Plan`](/docs/api/experimental_plan_and_execute/types/Plan)\[\]\>
...
> **bind**(`kwargs`: `Partial`<`BaseCallbackConfig`\>): [`RunnableBinding`](/docs/api/schema_runnable/classes/RunnableBinding)<`string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage), [`Plan`](/docs/api/experimental_plan_and_execute/types/Plan), `BaseCallbackConfig`\>
...
[`RunnableBinding`](/docs/api/schema_runnable/classes/RunnableBinding)<`string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage), [`Plan`](/docs/api/experimental_plan_and_execute/types/Plan), `BaseCallbackConfig`\>
...
[langchain/src/experimental/plan\_and\_execute/outputParser.ts:18](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/experimental/plan_and_execute/outputParser.ts#L18)

### invoke()[](#invoke "Direct link to invoke()")

> **invoke**(`input`: `string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage), `options`?: `BaseCallbackConfig`): `Promise`<[`Plan`](/docs/api/experimental_plan_and_execute/types/Plan)\>
...
[langchain/src/experimental/plan\_and\_execute/outputParser.ts:9](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/experimental/plan_and_execute/outputParser.ts#L9)
...
> **pipe**<NewRunOutput\>(`coerceable`: [`RunnableLike`](/docs/api/schema_runnable/types/RunnableLike)<[`Plan`](/docs/api/experimental_plan_and_execute/types/Plan), `NewRunOutput`\>): [`RunnableSequence`](/docs/api/schema_runnable/classes/RunnableSequence)<`string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage), `NewRunOutput`\>
...
[`RunnableLike`](/docs/api/schema_runnable/types/RunnableLike)<[`Plan`](/docs/api/experimental_plan_and_execute/types/Plan), `NewRunOutput`\>
...
> **stream**(`input`: `string` | [`BaseMessage`](/docs/api/schema/classes/BaseMessage), `options`?: `Partial`<`BaseCallbackConfig`\>): `Promise`<`IterableReadableStream`<[`Plan`](/docs/api/experimental_plan_and_execute/types/Plan)\>\>
...
`Promise`<`IterableReadableStream`<[`Plan`](/docs/api/experimental_plan_and_execute/types/Plan)\>\>
...
> `Protected` **\_callWithConfig**<T\>(`func`: `Function`, `input`: `T`, `options`?: `BaseCallbackConfig` & {`runType`?: `string`;}): `Promise`<[`Plan`](/docs/api/experimental_plan_and_execute/types/Plan)\>
...
(`input`: `T`) => `Promise`<[`Plan`](/docs/api/experimental_plan_and_execute/types/Plan)\>
