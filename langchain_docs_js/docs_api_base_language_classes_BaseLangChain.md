BaseLangChain<RunInput, RunOutput, CallOptions\>
================================================
...
*   [`Runnable`](/docs/api/schema_runnable/classes/Runnable)<`RunInput`, `RunOutput`, `CallOptions`\>.**BaseLangChain**
...
> **new BaseLangChain**<RunInput, RunOutput, CallOptions\>(`params`: [`BaseLangChainParams`](/docs/api/base_language/interfaces/BaseLangChainParams)): [`BaseLangChain`](/docs/api/base_language/classes/BaseLangChain)<`RunInput`, `RunOutput`, `CallOptions`\>
...
[`BaseLangChain`](/docs/api/base_language/classes/BaseLangChain)<`RunInput`, `RunOutput`, `CallOptions`\>
...
[langchain/src/base\_language/index.ts:59](https://github.com/hwchase17/langchainjs/blob/1c1274d/langchain/src/base_language/index.ts#L59)
