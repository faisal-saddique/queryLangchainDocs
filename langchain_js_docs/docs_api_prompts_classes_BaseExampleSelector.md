...
*   [`Serializable`](/docs/api/load_serializable/classes/Serializable).**BaseExampleSelector**
...
> **new BaseExampleSelector**(`kwargs`?: `SerializedFields`, ...`_args`?: `never`\[\]): [`BaseExampleSelector`](/docs/api/prompts/classes/BaseExampleSelector)
...
> `Abstract` **addExample**(`example`: [`Example`](/docs/api/schema/types/Example)): `Promise`<`string` | `void`\>
...
[langchain/src/prompts/base.ts:188](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/prompts/base.ts#L188)

### selectExamples()[​](#selectexamples "Direct link to selectExamples()")

> `Abstract` **selectExamples**(`input_variables`: [`Example`](/docs/api/schema/types/Example)): `Promise`<[`Example`](/docs/api/schema/types/Example)\[\]\>
...
[langchain/src/prompts/base.ts:190](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/prompts/base.ts#L190)
