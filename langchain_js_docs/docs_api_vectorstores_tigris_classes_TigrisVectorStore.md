...
[langchain/src/vectorstores/tigris.ts:19](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/tigris.ts#L19)
...
[langchain/src/vectorstores/tigris.ts:13](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/tigris.ts#L13)
...
[langchain/src/vectorstores/tigris.ts:15](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/tigris.ts#L15)
...
[langchain/src/vectorstores/tigris.ts:26](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/tigris.ts#L26)
...
[langchain/src/vectorstores/tigris.ts:38](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/tigris.ts#L38)

### asRetriever()[​](#asretriever "Direct link to asRetriever()")

> **asRetriever**(`kOrFields`?: `number` | [`VectorStoreRetrieverInput`](/docs/api/vectorstores_base/interfaces/VectorStoreRetrieverInput)<[`TigrisVectorStore`](/docs/api/vectorstores_tigris/classes/TigrisVectorStore)\>, `filter`?: `object`, `callbacks`?: [`Callbacks`](/docs/api/callbacks/types/Callbacks), `tags`?: `string`\[\], `metadata`?: `Record`<`string`, `unknown`\>, `verbose`?: `boolean`): [`VectorStoreRetriever`](/docs/api/vectorstores_base/classes/VectorStoreRetriever)<[`TigrisVectorStore`](/docs/api/vectorstores_tigris/classes/TigrisVectorStore)\>
...
`number` | [`VectorStoreRetrieverInput`](/docs/api/vectorstores_base/interfaces/VectorStoreRetrieverInput)<[`TigrisVectorStore`](/docs/api/vectorstores_tigris/classes/TigrisVectorStore)\>
...
[langchain/src/vectorstores/tigris.ts:63](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/tigris.ts#L63)
...
[langchain/src/vectorstores/tigris.ts:105](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/tigris.ts#L105)
...
[langchain/src/vectorstores/tigris.ts:115](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/tigris.ts#L115)
...
[langchain/src/vectorstores/tigris.ts:87](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/tigris.ts#L87)