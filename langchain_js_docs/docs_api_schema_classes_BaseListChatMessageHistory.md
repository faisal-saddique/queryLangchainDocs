...
> `Protected` `Abstract` **addMessage**(`message`: [`BaseMessage`](/docs/api/schema/classes/BaseMessage)): `Promise`<`void`\>
...
[langchain/src/schema/index.ts:273](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/schema/index.ts#L273)