...
*   [`Serializable`](/docs/api/load_serializable/classes/Serializable).**BaseLangChain**
...
> **new BaseLangChain**(`params`: [`BaseLangChainParams`](/docs/api/base_language/interfaces/BaseLangChainParams)): [`BaseLangChain`](/docs/api/base_language/classes/BaseLangChain)
...
[langchain/src/base\_language/index.ts:53](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/base_language/index.ts#L53)
