...
*   [`BaseListChatMessageHistory`](/docs/api/schema/classes/BaseListChatMessageHistory).**MomentoChatMessageHistory**
...
[langchain/src/stores/message/momento.ts:51](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/stores/message/momento.ts#L51)
...
[langchain/src/stores/message/momento.ts:129](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/stores/message/momento.ts#L129)
...
[langchain/src/stores/message/momento.ts:149](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/stores/message/momento.ts#L149)
...
[langchain/src/stores/message/momento.ts:108](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/stores/message/momento.ts#L108)
...
> `Static` **fromProps**(`props`: [`MomentoChatMessageHistoryProps`](/docs/api/stores_message_momento/interfaces/MomentoChatMessageHistoryProps)): `Promise`<[`MomentoChatMessageHistory`](/docs/api/stores_message_momento/classes/MomentoChatMessageHistory)\>
...
`Promise`<[`MomentoChatMessageHistory`](/docs/api/stores_message_momento/classes/MomentoChatMessageHistory)\>

A new chat message history backed by Momento.

#### Defined in[​](#defined-in-16 "Direct link to Defined in")

[langchain/src/stores/message/momento.ts:88](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/stores/message/momento.ts#L88)