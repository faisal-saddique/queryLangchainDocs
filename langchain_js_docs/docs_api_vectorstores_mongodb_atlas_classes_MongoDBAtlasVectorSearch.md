...
[langchain/src/vectorstores/mongodb\_atlas.ts:28](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/mongodb_atlas.ts#L28)
...
[langchain/src/vectorstores/mongodb\_atlas.ts:14](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/mongodb_atlas.ts#L14)
...
[langchain/src/vectorstores/mongodb\_atlas.ts:16](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/mongodb_atlas.ts#L16)

### embeddingKey[​](#embeddingkey "Direct link to embeddingKey")

> **embeddingKey**: `string`

#### Defined in[​](#defined-in-3 "Direct link to Defined in")

[langchain/src/vectorstores/mongodb\_atlas.ts:22](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/mongodb_atlas.ts#L22)
...
[langchain/src/vectorstores/mongodb\_atlas.ts:18](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/mongodb_atlas.ts#L18)
...
[langchain/src/vectorstores/mongodb\_atlas.ts:20](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/mongodb_atlas.ts#L20)
...
[langchain/src/vectorstores/mongodb\_atlas.ts:24](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/mongodb_atlas.ts#L24)
...
[langchain/src/vectorstores/mongodb\_atlas.ts:45](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/mongodb_atlas.ts#L45)
...
[langchain/src/vectorstores/mongodb\_atlas.ts:36](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/mongodb_atlas.ts#L36)

### asRetriever()[​](#asretriever "Direct link to asRetriever()")

> **asRetriever**(`kOrFields`?: `number` | [`VectorStoreRetrieverInput`](/docs/api/vectorstores_base/interfaces/VectorStoreRetrieverInput)<[`MongoDBAtlasVectorSearch`](/docs/api/vectorstores_mongodb_atlas/classes/MongoDBAtlasVectorSearch)\>, `filter`?: `Document`, `callbacks`?: [`Callbacks`](/docs/api/callbacks/types/Callbacks), `tags`?: `string`\[\], `metadata`?: `Record`<`string`, `unknown`\>, `verbose`?: `boolean`): [`VectorStoreRetriever`](/docs/api/vectorstores_base/classes/VectorStoreRetriever)<[`MongoDBAtlasVectorSearch`](/docs/api/vectorstores_mongodb_atlas/classes/MongoDBAtlasVectorSearch)\>
...
`number` | [`VectorStoreRetrieverInput`](/docs/api/vectorstores_base/interfaces/VectorStoreRetrieverInput)<[`MongoDBAtlasVectorSearch`](/docs/api/vectorstores_mongodb_atlas/classes/MongoDBAtlasVectorSearch)\>
...
> **similaritySearch**(`query`: `string`, `k`: `number`, `preFilter`?: `Document`, `postFilterPipeline`?: `Document`\[\]): `Promise`<[`Document`](/docs/api/document/classes/Document)<`Record`<`string`, `any`\>\>\[\]\>
...
[langchain/src/vectorstores/mongodb\_atlas.ts:97](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/mongodb_atlas.ts#L97)

### similaritySearchVectorWithScore()[​](#similaritysearchvectorwithscore "Direct link to similaritySearchVectorWithScore()")

> **similaritySearchVectorWithScore**(`query`: `number`\[\], `k`: `number`, `preFilter`?: `Document`, `postFilterPipeline`?: `Document`\[\]): `Promise`<\[[`Document`](/docs/api/document/classes/Document)<`Record`<`string`, `any`\>\>, `number`\]\[\]\>
...
[langchain/src/vectorstores/mongodb\_atlas.ts:53](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/mongodb_atlas.ts#L53)

### similaritySearchWithScore()[​](#similaritysearchwithscore "Direct link to similaritySearchWithScore()")

> **similaritySearchWithScore**(`query`: `string`, `k`: `number` = `4`, `filter`: `undefined` | `Document` = `undefined`, `_callbacks`: `undefined` | [`Callbacks`](/docs/api/callbacks/types/Callbacks) = `undefined`): `Promise`<\[[`Document`](/docs/api/document/classes/Document)<`Record`<`string`, `any`\>\>, `number`\]\[\]\>
...
[langchain/src/vectorstores/mongodb\_atlas.ts:130](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/mongodb_atlas.ts#L130)
...
[langchain/src/vectorstores/mongodb\_atlas.ts:112](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/vectorstores/mongodb_atlas.ts#L112)