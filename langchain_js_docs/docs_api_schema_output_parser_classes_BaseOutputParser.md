...
*   [`BaseLLMOutputParser`](/docs/api/schema_output_parser/classes/BaseLLMOutputParser)<`T`\>.**BaseOutputParser**
...
> **new BaseOutputParser**<T\>(`kwargs`?: `SerializedFields`, ...`_args`?: `never`\[\]): [`BaseOutputParser`](/docs/api/schema_output_parser/classes/BaseOutputParser)<`T`\>
...
[langchain/src/schema/output\_parser.ts:64](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/schema/output_parser.ts#L64)

### parse()[​](#parse "Direct link to parse()")

Parse the output of an LLM call.

> `Abstract` **parse**(`text`: `string`, `callbacks`?: [`Callbacks`](/docs/api/callbacks/types/Callbacks)): `Promise`<`T`\>
...
[langchain/src/schema/output\_parser.ts:43](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/schema/output_parser.ts#L43)
