...
*   [`Serializable`](/docs/api/load_serializable/classes/Serializable).**BasePromptValue**
...
> **new BasePromptValue**(`kwargs`?: `SerializedFields`, ...`_args`?: `never`\[\]): [`BasePromptValue`](/docs/api/schema/classes/BasePromptValue)
...
> `Abstract` **toChatMessages**(): [`BaseMessage`](/docs/api/schema/classes/BaseMessage)\[\]
...
[langchain/src/schema/index.ts:239](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/schema/index.ts#L239)
...
[langchain/src/schema/index.ts:237](https://github.com/hwchase17/langchainjs/blob/46e1734/langchain/src/schema/index.ts#L237)